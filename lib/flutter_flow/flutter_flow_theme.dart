...
abstract class FlutterFlowTheme {
  ...
  static void saveThemeMode(ThemeMode mode) {
    // ไม่จำเป็นต้องบันทึกโหมดเพราะเราใช้โหมดสว่างเท่านั้น
  }
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFFFEAAF);
  ...
  late Color secondaryBackground = const Color(0xFFFFFDF5);
  late Color accent1 = const Color(0x4CFFD700);
  late Color accent2 = const Color(0x4DFFC107);
  late Color accent3 = const Color(0x4DFFDF80);
